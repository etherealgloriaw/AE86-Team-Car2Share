...
export const UserHistory = () => {
    ...
    var renderedPosts = posts.map((slice) => {
        ...
        const dateString = new Date(slice.startingTime).toUTCString().slice(0,-3);
    ...
    return (
        <div className="postsInProfilePage">
            <FormGroup>
                <FormControlLabel
                    control={<Switch checked={status} defaultChecked={true} onChange={handleChange}
            ...
            <AppBar position="static">
                <Toolbar>
                    ...
                    <Grid id="buttons" container
                          ...
                          alignItems="center">
                        <Grid>
                            <Button id="ongoing" color="inherit" value={'ongoing'} onClick={handleTimeChange}
                                    name={'ongoing'} className={classes.basicButton}>Ongoing</Button>
                        </Grid>

                        <Grid>
                            <Button id="upcoming" color="inherit" value={'upcoming'} onClick={handleTimeChange}
                                    name={'upcoming'} className={classes.basicButton}>Upcoming</Button>
                        </Grid>
                        <Grid>
                            <Button id="history" color="inherit" value={'history'} onClick={handleTimeChange}
                                    name={'history'} className={classes.basicButton}>History</Button>
                        </Grid>
                    </Grid>
                </Toolbar>
            </AppBar>
